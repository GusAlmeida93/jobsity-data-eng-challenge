variable "airflow_custom_role" {
    description = "Jobsity Airflow Custom Role Permissions"
    type        =  list
    default     = ["artifactregistry.aptartifacts.create",
...
variable "bigquery_user_custom_role" {
    description = "Jobsity BigQuery User Custom Role Permissions"
    type        =  list
    default = ["bigquery.bireservations.get",
